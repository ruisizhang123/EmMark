...
def run_awq(
    ...
    calib_data="pileval", save_activation_wm=None
):
    ...
    activation_wm_results = {"activation": []}
    ...
    for i in tqdm.tqdm(range(len(layers)), desc="Running AWQ..."):
        ...
        if auto_scale:  # if it applies, we should also modify the input_feat with scales
            scales_list, act_list = auto_scale_block(
                layer, layer_kwargs,
        ...
        activation_wm_results["activation"] += append_str_prefix(act_list, get_op_name(model, layer) + ".")
        # Clear GPU memory
        torch.cuda.empty_cache()
        ...
        torch.cuda.empty_cache()
    #import pdb; pdb.set_trace()
    return awq_results, activation_wm_results
